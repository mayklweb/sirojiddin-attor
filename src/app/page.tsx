      ...
      <section className="w-full mt-10">
        <div className="container">
          ...
          <div className="mt-10 w-full flex gap-5">
            <div className="w-[40%]">
              <div className="w-full h-[620px] overflow-hidden rounded-t-[100%]">
                <img
            ...
            <div className="w-[60%] grid grid-cols-3 grid-rows-2 flex-col gap-5">
              <div className="w-full h-full">
                <div className="w-[250px] h-[280px] overflow-hidden rounded-t-[100%]">
                  <img
                    className="w-full h-full object-cover"
                    src="/image.jpg"
                    alt=""
      ...
      <section className="w-full mt-10">
        <div className="container">
          ...
          <div className="mt-10 w-full grid grid-cols-4 gap-5">
            <div className="w-full h-full">
              <div className="w-full h-[400px] overflow-hidden rounded-t-[100%]">
                <img
                  className="w-full h-full object-cover"
                  src="/image.jpg"
                  alt=""
              ...
              <div className="mt-2 flex justify-between">
                <h3 className="text-xl">CHANEL</h3>
        ...
        <div className="container">
          ...
          <div className="mt-10 w-full flex gap-5">
            ...
            <div className="w-[50%] h-full">
              <div className="w-full h-full mt-10">
                <div className="w-full h-[720px] overflow-hidden rounded-t-[100%]">
                  <img
                    className="w-full h-full object-cover"
                    src="/image.jpg"
                    alt=""
